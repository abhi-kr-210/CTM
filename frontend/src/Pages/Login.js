    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      try {
        ...
        if(!error?.response) {
          ...
          setErrors({message:'Missing Username or Password'});
            ...
            <div className='login_container_col'>
              ...
              {errors.message && <div style={{ color: 'red' }}>{errors.message}!</div>}
                ...
                <div className='mt-3'>
                  ...
                  <div><Link to="/register_photographer">Register as Snapper</Link></div>
                  <div><Link to="/register_user">Register as User</Link></div>
                </div>
              </Form>
            </div>
          </Col>
